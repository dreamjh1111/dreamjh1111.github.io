---
title: Quartz 블로그에 SEO 최적화 적용하기
...
[[02-SEO란 무엇이고 어떻게 최적화할까]]에서 SEO의 원리와 기법을 정리했다. 이 글에서는 그 내용을 바탕으로 이 블로그(Quartz v4 + GitHub Pages)에 **실제로 적용한 작업**을 코드 단위로 기록한다.
...
[[02-SEO란 무엇이고 어떻게 최적화할까]]에서 정리한 "이 블로그에서 바로 적용할 항목"과 대조한다.
